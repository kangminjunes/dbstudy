/*
    ...
    2. 'X' 값을 가지고 있다.
    3. FROM절이 필요 없는 SELECT문을 사용할 떄 DUAL 테이블을 이용한다.
*/
...
/*
    3. 날짜 -> 문자로 변환하기
        ...
        * 날짜/시간 형식
        ...
        3) MM   : 월 2자리 (01~12)
        4) DD   : 일 2자리 (01~31)
        5) AM   : 오전 / 오후       시간 필기 방법 2가지
        6) HH   : 12시각(01~12)      1. 5~6번 같이 필기
        7) HH24 : 24시간(00~23)      2. 7번 한개만 사용
        8) MI   : 분(00~59)
        9) SS   : 초(00~59)
*/
SELECT TO_CHAR(HIRE_DATE, 'YYYY-MM-DD')
    FROM EMPLOYEES; --EX) 2005-01-06  같은 형식 정리되어 출력
    
/*
    4. 문자-> 날짜로 변환하기
    TO_DATE(문자, [형식]) --[형식] 생략 가능 하다.
*/
...
-- TO_DATE 날짜를 해석해주는거 해당 날짜로 만들어주는 형식의 문법이다.
